            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <a type="button" href="javascript:void(0)" class="btn btn-primary btn-sm float-right"
                       data-toggle="modal" data-target="#user-modal">Add City</a>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
    ...
    <div class="modal fade" id="user-modal">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form role="form" action="{{route('city.store')}}" class="needs-validation bootstrap-form" method="post" novalidate>
                    @csrf
    ...
    @push('scripts')
        ...
        <script>
                ...
                var table = $("#example1").DataTable({
                    ...
                    "processing": true,
                    "serverSide": true,
                    "ajax": {url: "{{route('getCity')}}", type: 'post'},
                    "language": {
